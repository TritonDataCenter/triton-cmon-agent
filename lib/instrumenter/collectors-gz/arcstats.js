...
var ARCSTAT_KSTATS = [
    ...
    /*
     * 'sync_wait_for_async' has been replaced by 'async_upgrade_sync' in
     * recent releases. We export both metrics knowing that only one of the
     * two is going to be available.
     */
    {
        'missingAllowed': true,
    ...
    {
        'missingAllowed': true,
        'kstat_key': 'async_upgrade_sync',
        'key': 'arcstats_async_upgrade_sync_total',
        'type': 'counter',
        'help': 'Number of times an async read was upgraded to sync because ' +
            'another sync read was waiting for it'
    },
    {
...
function ArcstatMetricCollector(opts) {
    ...
    self.kstatReadOpts = ARCSTAT_READ_OPTS;
}
