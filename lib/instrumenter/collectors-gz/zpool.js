    ...
    keys = [
        {
            'key': 'allocated',
            'unit': 'bytes',
            'desc': 'Amount of storage space used withing the pool'
        },
        {
            'key': 'fragmentation',
            'unit': 'percent',
            'desc': 'Amount of fragmentation in the pool',
            'encoder': zpoolFragEnc
        },
        {
            'key': 'health',
            'unit': 'status',
            'desc': 'The current health of the pool (' +
                ...
                '-1 = UNKNOWN)',
            'encoder': zpoolHealthEnc
        },
        {
            'key': 'size',
            'unit': 'bytes',
            'desc': 'Total size of the pool'
        }
    ];
